...
export const darkBluePalette = {
  //white #ffffff  green#1ebd34   dark blue#3c4261
  primary: {
    main: "#3c4261",
    light: "#1ebd34"
  },
...
const selectedPalette = darkBluePalette;  //  defaultPalette | redPalette | yellowPalette
...
const theme = createMuiTheme({
  palette: {
    ...
    editButton: {main: selectedPalette.editButton.main},
